                            ...
                            <table role="presentation" style="width:94%;max-width:600px;border:none;border-spacing:0;text-align:left;font-family:Arial,sans-serif;font-size:16px;line-height:22px;color:#363636;">
                                <tr>
                                    <td style="padding:40px 30px 30px 30px;text-align:center;font-size:24px;font-weight:bold;">
                                        <a href="#" style="text-decoration:none;"><img src="http://ridesharedev.katdev.com/assets/admin/images/logo.png" width="165" alt="Logo" style="width:80%;max-width:165px;height:auto;border:none;text-decoration:none;color:#ffffff;"></a>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td style="padding:30px;text-align:center;font-size:12px;background-color:#071C36;;color:#cccccc;">
                                        <p style="margin:0;font-size:14px;line-height:20px;">&reg; ZipTo 2021-2022</p>
                                    </td>
                                </tr>
                            </table>
                        </td>
