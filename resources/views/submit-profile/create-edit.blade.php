    ...
    <div class="content">
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card mb-3 edit-profile-card">
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('users.submit-profile') }}" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                <label for="email" class="form-label">Email <span class="strik-color">*</span></label>
                            ...
                            <div class="mb-3">
                                <label for="gender" class="form-label">Gender <span class="strik-color">*</span></label>
                            ...
                            <div class="mb-3">
                                <label for="weight" class="form-label">About me <small style="color:red;">(maximum 300
                    ...
                    <div class="ms-3 mb-3">
                        <label for="gallery" class="form-label ">Headshot Images</label>
                        <div class="d-flex">
                            <label class="thumbnail" for="image1">
                                @if (isset($userInfo?->images[0]?->image))
                                    <img src="{{ $userInfo?->images[0]?->image }}" class="custom-image" id="preview1"
                                        alt="Image 1">
                                @else
                                    <img src="https://via.placeholder.com/180x180" alt="Image 1" id="preview1" />
                                @endif
                            ...
                            <label class="thumbnail" for="image2">
                                ...
                                @else
                                    <img src="https://via.placeholder.com/180x180" alt="Image 2" id="preview2" />
                            ...
                            @else
                            <img src="https://via.placeholder.com/180x180" alt="Image 3" id="preview3" />
                            @endif
                        ...
                        @error('image1')
                            ...
                            <br />
                        @enderror
                        <small class="fst-italic small text-danger">*Click thumbnail to upload headshot images</small>
                    </div>
                    <div class="ms-3 me-3">
                        <div class="mb-3">
                            <label for="intro_video" class="form-label">Intro Video</label>
                            <input type="text" id="intro_video" name="intro_video_link" class="form-control"
                                placeholder="Enter intro video" value="{{ old('intro_video_link',isset( $userIntroVideo?->intro_video_link) ?  $userIntroVideo?->intro_video_link : ' ') }}" />
                        </div>
                        <div class="mb-3">
                            <label for="work_reel_1" class="form-label">Work Reel 1 <small>(only youtube
                                    links)</small></label>
                            <input type="text" id="work_reel_1" name="work_reel1" class="form-control"
                                value="{{ old('work_reel1',isset($userProfile->work_reel1) ? $userProfile->work_reel1 : ' ') }}" placeholder="Work Reel 1 - only youtube link" />
                        </div>
                        <div class="mb-3">
                            <label for="work_reel_2" class="form-label">Work Reel 2 <small>(only youtube
                                    links)</small></label>
                            <input type="text" id="work_reel_2" name="work_reel2" class="form-control"
                                value="{{ old('work_reel2',isset($userProfile->work_reel2) ? $userProfile->work_reel2 : ' ') }}" placeholder="Work Reel 2 - only youtube link" />
                        </div>
                        <div class="mb-3">
                            <label for="work_reel_3" class="form-label">Work Reel 3 <small>(only youtube
                                    links)</small></label>
                            <input type="text" id="work_reel_3" name="work_reel3" value="{{ old('work_reel3',isset($userProfile->work_reel3) ? $userProfile->work_reel3 : ' ') }}"
