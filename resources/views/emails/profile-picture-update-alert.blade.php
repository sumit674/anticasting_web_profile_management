                                        ...
                                        <tr>
                                            <td style="padding-top: 20px; padding-bottom: 20px; padding-right: 0px;"
                                                align="right" valign="middle" class="webview"> <a href="#"
                                                    ...
                                                    target="_blank" class="text hideOnMobile">Oh wait, theres more!
                                                    →</a>
                                            </td>
                                        </tr>
                                    </tbody>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td style="padding-top: 60px; padding-bottom: 20px;" align="center"
                                                ...
                                                <a href="{{ route('users.home') }}" style="text-decoration:none"
                                                    target="_blank">
                                                    <img alt="" border="0"
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td style="padding-bottom: 20px;" align="center"
                                                                ...
                                                                <h5 class="text"
                                                                    style="color:#666;font-family:'Open Sans',Helvetica,Arial,sans-serif;font-size:18px;font-weight:600;font-style:normal;letter-spacing:normal;line-height:22px;text-transform:none;text-align:center;padding:0;margin:0">
                                                                    Your profile is six month old ,Please Update
                                                                </h5>
                                                            </td>
                                                        </tr>
                                                    </tbody>
