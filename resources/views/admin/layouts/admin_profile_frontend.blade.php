...
<body>
    <div id="wrapper">
        {{-- Sidebar --}}
        @include('admin.includes.admin-submit-profile.sidebar')
        <!-- Content Wrapper -->
        <div id="content-wrapper" class="d-flex flex-column">
            <!-- Main Content -->
            <div id="content">
                <!-- Topbar -->
                @include('admin.includes.admin-submit-profile.header')
                <div>
                    @yield('content')
                </div>
            </div>
            @include('admin.includes.admin-submit-profile.footer')
        </div>
    </div>
